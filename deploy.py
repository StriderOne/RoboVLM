...
class DeployConfig:
    ...
    #openvla_path: Union[str, Path] = "ZijianZhang/OpenVLA-7B-GRAPE-Simpler"               # HF Hub Path (or path to local run directory)
    openvla_path: Union[str, Path] = "ZijianZhang/OpenVLA-7B-SFT-Simpler" # HF Hub Path (or path to local run directory)
    #openvla_path: Union[str, Path] = "Embodied-CoT/ecot-openvla-7b-bridge" # HF Hub Path (or path to local run directory)
